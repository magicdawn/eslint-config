...
declare const mgCustomRules: {
  ...
  readonly unicorn: {
    ...
    readonly 'unicorn/no-unused-array-method-return': "off";
    readonly 'unicorn/no-declarations-before-early-exit': "off";
    readonly 'unicorn/throw-new-error': "off";
    readonly 'unicorn/no-exports-in-scripts': "off";
    readonly 'unicorn/no-top-level-side-effects': "off";
    readonly 'unicorn/no-global-object-property-assignment': "off";
    readonly 'unicorn/no-unnecessary-global-this': "off";
    readonly 'unicorn/explicit-timer-delay': "off";
    readonly 'unicorn/no-array-from-fill': "off";
    readonly 'unicorn/no-unnecessary-nested-ternary': "off";
    readonly 'unicorn/no-useless-continue': "off";
    readonly 'unicorn/prefer-early-return': "off";
    ...
    readonly 'unicorn/prefer-boolean-return': "off";
